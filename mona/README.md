...
```
docker run -d --name=monacoin -p 9401:9401 -v=/crypto/monacoin/config:/opt/blockchain/config -v=/crypto/monacoin/data:/opt/blockchain/data blocknetdx/monacoin:0.17.0.1
```
...
```
docker run -d --restart=no --name=monacoin -p 9401:9401 blocknetdx/monacoin:0.17.0.1 monacoind -daemon=0 -rpcuser=mona -rpcpassword=mona123
docker run -d --restart=on-failure:10 --name=monacoin -p 9401:9401 blocknetdx/monacoin:0.17.0.1 monacoind -daemon=0 -rpcuser=mona -rpcpassword=mona123
docker run -d --restart=unless-stopped --name=bitcoin -p 9401:9401 blocknetdx/monacoin:0.17.0.1 monacoind -daemon=0 -rpcuser=mona -rpcpassword=mona123
docker run -d --restart=always --name=bitcoin -p 9401:9401 blocknetdx/monacoin:0.17.0.1 monacoind -daemon=0 -rpcuser=mona -rpcpassword=mona123
```
