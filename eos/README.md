...
* `docker pull blocknetdx/eos:v2.0.1`

**Step 2**

Run your container:

* `docker run -d -p 9876:9876 -p 8888:8888 -p 8080:8080 -v /opt/eos/:/root/.local/share/eosio/  --name eos blocknetdx/eos:v2.0.1`

_or_

**Step 2.a** *only required for non `docker -v` setups:*

* `docker run -d -p 9876:9876 -p 8888:8888 -p 8080:8080 --name eos blocknetdx/eos:v2.0.1`
